...
# You obtained some results on the fraud detection test set but you are not 100% sure of your model. Nobody's perfect!
...
def gradient_check_n(parameters, gradients, X, Y, epsilon=1e-7):
    ...
    for i in range(num_parameters):
        ...
        thetaplus[i][0] = parameters_values[i] + epsilon  # Step 2
        ...
        thetaminus[i][0] = parameters_values[i] - epsilon  # Step 2
...
#   is computationally costly. For this reason, we don't run gradient checking at every iteration during training.
...
# Correct the backward_propagation() thanks to our gradient_check()
