...
def random_mini_batches(X, Y, mini_batch_size=64, seed=0):
    ...
    Y -- true "label" vector (1 for blue dot / 0 for red dot), of
...
def initialize_adam(parameters):
    ...
    Initializes v and s as two python dictionaries with:
                - keys: "dW1", "db1", ..., "dWL", "dbL"
                - values: numpy arrays of zeros of the same shape as
                the corresponding gradients/parameters.
    ...
    for i in range(num_epochs):
        ...
        for minibatch in minibatches:
            ...
            if optimizer == "gd":
                ...
                parameters, v = update_parameters_with_momentum(parameters, grads, v,
                                                                beta, learning_rate)
            elif optimizer == "adam":
                t = t + 1  # Adam counter
                parameters, v, s = update_parameters_with_adam(parameters, grads, v, s,
                                                               t, learning_rate, beta1,
                                                               beta2, epsilon)
